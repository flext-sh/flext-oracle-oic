...
- Public extensions exposed by this project: `FlextOracleOicApi`, `FlextOracleOicAuthMixin`, `FlextOracleOicCli`, `FlextOracleOicConstants`, `FlextOracleOicIntegrationCrudMixin`, `FlextOracleOicIntegrationLifecycleMixin` (+9 more).
