# Triagem Semgrep — flext-sh/flext-oracle-oic

Gerado do dump da plataforma Semgrep (deployment `datacosmos`, 2026-08-06).

Bead de rastreio: `mro-p57t.17`
...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 613 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-oracle-oic.json`
