...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-oracle-oic — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:613`
...
```toml
      609  all = true
      610  in_place = true
      611  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      612  
>>>   613  [tool.uv]
      614  link-mode = "copy"
      615  
      616  [tool.vulture]
      617  exclude = ["*/_protocols/*"]
```
