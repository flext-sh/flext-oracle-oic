...
if _t.TYPE_CHECKING:
    from _utilities.api_request_builder import FlextOracleOicUtilitiesAPIRequestBuilder
    ...
    from _utilities.pattern_analysis import FlextOracleOicUtilitiesPatternAnalysis
